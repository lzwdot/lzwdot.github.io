import{d,x as n,p as m,c as a,o as i,j as t,e as f,r as _,_ as p}from"./framework.DmTz0k4P.js";const g={class:"jsDemo"},v={key:0,open:"true",class:"details custom-block"},h=["innerHTML"],L=d({__name:"JsDemo",setup(k){const s=n(""),r=n(),c=n();return m(()=>{const e=c.value?.contentWindow?.document;if(e){let o=r?.value?.textContent;const l="js";o?.trim().startsWith(l)&&(o=o.trim().substring(l.length));const u=`
    <script>
      const logs = [];
