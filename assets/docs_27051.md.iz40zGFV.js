import{_ as i,c as a,o as n,aj as l}from"./chunks/framework.C5r0OjI4.js";const c=JSON.parse('{"title":"Vue 模板编译","description":"","frontmatter":{"date":"2020-11-16 18:27:19"},"headers":[],"relativePath":"docs/27051.md","filePath":"docs/2.vuejs-use/vuejs-principle/27051.md","lastUpdated":1735962194000}'),t={name:"docs/27051.md"};function p(e,s,h,k,r,d){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="vue-模板编译" tabindex="-1">Vue 模板编译 <a class="header-anchor" href="#vue-模板编译" aria-label="Permalink to “Vue 模板编译”">​</a></h1><p>with 语法</p><ul><li>前置知识：JS 的 with 语法</li><li>vue template complier 将模板编译为 render 函数</li><li>执行 render 函数生成 vnode</li></ul><p>with 语法，不推荐使用</p><ul><li>改变 {} 内自由变量的查找规则，当做 obj 的属性来查找</li><li>如果找不到匹配的 obj 属性，就会报错</li><li>with 要慎用，它打破了作用域规则，易读性变差</li></ul><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> obj</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { a: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">100</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, b: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">200</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> };</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>模板编译</p><ul><li>模板不是 html，有指令，插值，JS 表达式，能实现判断，循环</li><li>html 是标签语言，只有 JS 才能实现判断，循环（图灵完备的）</li><li>因此，模板一定是转换成某种 JS 代码，即编译模板</li></ul><p>代码演示，需要引入 vue-template-compiler</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> compiler</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> require</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;vue-template-compiler&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // 从 vue 源码中找到缩写函数的含义</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// }</span></span></code></pre></div><ul><li>模板编译为 render 函数，执行 render 函数返回 vnode</li><li>基于 vnode 再执行 patch 和 diff</li><li>使用 webpack vue-loader，会在开发环境下编译模板（重要）</li></ul>`,11)])])}const o=i(t,[["render",p]]);export{c as __pageData,o as default};
